...
fn render(
    ...
    if let Some(p) = &m.pnl {
        ...
        row(
            ui,
            th,
            &ctx.text("ui.finance.revenue_net"),
            &ctx.money(p.revenue),
        );
        ...
        row(
            ui,
            th,
            &ctx.text("ui.finance.utilities"),
            &ctx.money(p.utilities),
        );
        row(
            ui,
            th,
            &ctx.text("ui.finance.depreciation"),
            &ctx.money(p.depreciation),
        );
        row(
            ui,
            th,
            &ctx.text("ui.finance.interest"),
            &ctx.money(p.interest),
        );
        row(
            ui,
            th,
            &ctx.text("ui.finance.write_off"),
            &ctx.money(p.write_off),
        );
    ...
    if let Some(b) = &m.balance {
        ...
        row(
            ui,
            th,
            &ctx.text("ui.finance.inventory"),
            &ctx.money(b.inventory),
        );
        row(
            ui,
            th,
            &ctx.text("ui.finance.fixed"),
            &ctx.money(b.fixed_net),
        );
        ...
        row(
            ui,
            th,
            &ctx.text("ui.finance.trade_payable"),
            &ctx.money(b.trade_payable),
        );
        // VAT stoi **tutaj**, po stronie zobowiązań, i nigdzie indziej (`K-7`).
        row(
            ui,
            th,
            &ctx.text("ui.finance.tax_payable"),
            &ctx.money(b.tax_payable),
        );
        row(
            ui,
            th,
            &ctx.text("ui.finance.wage_payable"),
            &ctx.money(b.wage_payable),
        );
        row(ui, th, &ctx.text("ui.finance.loans"), &ctx.money(b.loans));
        row(
            ui,
            th,
            &ctx.text("ui.finance.equity"),
            &ctx.money(b.equity_total),
        );
    }
    ...
    if let Some(c) = &m.cash {
        ...
        row(
            ui,
            th,
            &ctx.text("ui.finance.operating"),
            &ctx.money(c.operating),
        );
        row(
            ui,
            th,
            &ctx.text("ui.finance.investing"),
            &ctx.money(c.investing),
        );
        row(
            ui,
            th,
            &ctx.text("ui.finance.financing"),
            &ctx.money(c.financing),
        );
        if !c.complete {
