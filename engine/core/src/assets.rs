...
//!
//! W `core`, bo katalog danych jest kontraktem globalnym (00 §5), a nie własnością
//! `sim/world`: od M3 sięga po niego także `sim/agents` (tabela potrzeb), który
//! o `sim/world` nie wie i wiedzieć nie może — zależność idzie w drugą stronę.
//!
