...
| 49 | `sim/economy/src/market/restock.rs` | `impl Market` — 327 linii (ostrzeżenie od 300; 285 przed M9e) | Szew zaopatrzenia dostał w M9e cel zapasu sterowany przez gracza (`set_restock_days`, `restock_days`) — dwie metody o tym samym temacie co reszta pliku. Przeniesienie ich gdzie indziej dałoby trzecie miejsce, w którym mowa o polityce zamawiania | M6 albo M10 przy pierwszej zmianie polityki zamówień; wtedy „ile zamawiać" i „kiedy wyłożyć" rozejdą się same |
