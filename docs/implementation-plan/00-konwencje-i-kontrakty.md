...
- Katalogi: `data/goods/`, `data/recipes/`, `data/jobs/`, `data/buildings/`, `data/grammar/`,
  ...
  właściciel M5. `choice.ron` i `shop.ron` są plikami, które stroi **balansator**,
  i od M5e to on odpowiada za ich wartości — `min_margin_bp` z `shop.ron` jest
  dolnym ogranicznikiem ceny, czyli mechanizmem, którego pilnuje bramka G3).
